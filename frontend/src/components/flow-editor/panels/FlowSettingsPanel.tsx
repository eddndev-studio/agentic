    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <div style={{ display: 'flex', gap: 8 }}>
                <label style={{ flex: 1 }}>
                    <span className="fe-label">Usage limit</span>
                    <select value={flow.usageLimit} onChange={e => setFlow({ ...flow, usageLimit: parseInt(e.target.value) })} className="fe-select">
                ...
                <label style={{ flex: 1 }}>
                    <span className="fe-label">Cooldown</span>
                    <select value={flow.cooldownMs} onChange={e => setFlow({ ...flow, cooldownMs: parseInt(e.target.value) })} className="fe-select">
                        <option value="0">-</option>
            ...
            {availableFlows.length > 0 && (
                <div>
                    <span className="fe-label">Mutually exclusive with:</span>
                    <div style={{
